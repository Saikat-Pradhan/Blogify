...
export default function BlogDetails() {
  ...
  return (
    <div className='h-screen overflow-scroll bg-amber-200 dark:bg-neutral-800 flex justify-center pt-[1cm] pb-[1cm] pl-[1cm] lg:pl-[7cm] pr-[1cm] lg:pr-[7cm]'>
      <div className='bg-gradient-to-r from-blue-600 via-blue-500 to-black p-[6px] rounded-xl h-fit'>
        <div className='p-[1cm] bg-green-200 text-black dark:bg-neutral-900 dark:text-white rounded-xl'>
          ...
          <h3 className='text-[1.5rem] mt-[0.5cm] text-center font-serif'>Author: {blog.author}</h3>
        </div>
      </div>
    </div>
  );
